...
* Digit Signals (A, B, C, D): Correspond to the digits of a 4-digit number, whether hexadecimal or decimal. A logical level 0 activates the segment, as the display is common anode.
